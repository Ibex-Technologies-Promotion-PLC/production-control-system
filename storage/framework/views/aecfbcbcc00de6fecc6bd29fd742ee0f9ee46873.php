            ...
            <div class="h-40 p-5 flex justify-center flex-shrink-0 shadow-lg relative border-b border-indigo-200">
                ...
                <div class="flex-shrink-0">
                    <a href="<?php echo e(url('user/profile')); ?>">
                        <?php if (isset($component)) { $__componentOriginal8b4c28a5a40aa37c19f328b9ea6da5da10c10849 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\CircleImage::class, ['height' => 'h-20 w-20']); ?>
...
<?php endif; ?>
<?php if (isset($__componentOriginal8b4c28a5a40aa37c19f328b9ea6da5da10c10849)): ?>
<?php $component = $__componentOriginal8b4c28a5a40aa37c19f328b9ea6da5da10c10849; ?>
<?php unset($__componentOriginal8b4c28a5a40aa37c19f328b9ea6da5da10c10849); ?>
<?php endif; ?>
                    </a>
            ...
            <div class="h-20 p-3 px-5 flex justify-between items-center bg-gradient-to-b from-white to-gray-100">
                ...
                <a href="<?php echo e(route('work-orders.create')); ?>" data-tooltip="<?php echo e(__('workorders.create_work_order')); ?>" data-position="top left" data-variation="mini">
                    <i class="large link project diagram icon"></i>
                </a>
                <a href="<?php echo e(route('stock-moves.create')); ?>" data-tooltip="<?php echo e(__('stockmoves.stock_moves_create')); ?>" data-position="top left" data-variation="mini">
            ...
            <div class="flex flex-col ">
                <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div x-data="{submenu: false, submenuConfirm: false}" class="border-b border-dotted">
                        ...
                        <div class="pl-4 flex ease-in-out duration-200 <?php if($key === $activeMenuGroupKey): ?> bg-orange-500 <?php else: ?> hover:bg-indigo-50 <?php endif; ?>">
                            <a href="<?php echo e(route($menu['name'])); ?>" class="py-1 <?php if( ! array_key_exists('submenus', $menu)): ?> flex-1 <?php endif; ?>  <?php if($key === $activeMenuGroupKey): ?> text-white <?php endif; ?>"> 
                                <div class="h-8 flex items-center">
                                    <div><i class="<?php echo e($menu['icon']); ?> <?php if($key === $activeMenuGroupKey): ?> text-white <?php else: ?> text-gray-600 <?php endif; ?>"></i></div>
                                    <div class="pl-2"><p class="font-extrabold <?php if($key === $activeMenuGroupKey): ?> text-white <?php else: ?> text-gray-600 <?php endif; ?>"><?php echo e(__($menu['label'])); ?></p></div>
                                </div>
                            </a> 
                            <?php if(array_key_exists('submenus', $menu)): ?>
                                <div @click="submenu = ! submenu; submenuConfirm = true;" class="flex justify-end items-center cursor-pointer flex-1 text-right">
                                    <div class="pr-2">
                                        <i class="caret down icon <?php if($key === $activeMenuGroupKey): ?> text-white <?php else: ?> text-gray-600 <?php endif; ?>"></i>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        <?php if(array_key_exists('submenus', $menu)): ?>
                            <div x-show="submenu || ('<?php echo e($key); ?>' === '<?php echo e($activeMenuGroupKey); ?>') && ! submenuConfirm" class="shadow-inner bg-cool-gray-50 flex">
                                        ...
                                        <div class="flex justify-between border-b border-dashed last:border-b-0 hover:bg-blue-100">
                                            <div class="flex-1 px-4 font-bold cursor-pointer">
                                                <a href="<?php echo e(route($submenu['name'])); ?>"> 
                                                    <div class="flex items-center py-2 <?php if(route($submenu['name']) == request()->url()): ?> text-orange-500 <?php else: ?> text-gray-600 <?php endif; ?>">
                                                        <div><i class="<?php echo e($submenu['icon']); ?> "></i></div>
                                                        <div class="pl-2"><p class="font-extrabold"><?php echo e(__($submenu['label'])); ?></p></div>
                                                    </div>
                                                </a> 
                                            </div>
...
<?php /**PATH D:\projects\hexlabs\production-control-system\resources\views/web/layouts/partials/sidebar.blade.php ENDPATH**/ ?>