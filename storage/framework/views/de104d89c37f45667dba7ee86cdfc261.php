...
<?php $component = App\View\Components\Input::resolve(['model' => 'wo_lot_no','noErrors' => true,'label' => ''.e(__('validation.attributes.wo_lot_no')).'','placeholder' => ''.e(__('validation.attributes.wo_lot_no')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
