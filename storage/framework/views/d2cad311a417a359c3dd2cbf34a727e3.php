...
<?php $component = App\View\Components\PageHeader::resolve(['icon' => 'invoice file','header' => ''.e(__('salestypes.create_salestype')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = App\View\Components\Input::resolve(['model' => 'st_name','label' => ''.e(__('validation.attributes.st_name')).'','placeholder' => ''.e(__('validation.attributes.st_name')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal786b6632e4e03cdf0a10e8880993f28a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal786b6632e4e03cdf0a10e8880993f28a = $attributes; } ?>
<?php $component = App\View\Components\Input::resolve(['model' => 'st_abbr','label' => ''.e(__('validation.attributes.st_abbr')).'','placeholder' => ''.e(__('validation.attributes.st_abbr')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Muluye\Documents\production-control-system\resources\views/web/sections/salestype/baseform.blade.php ENDPATH**/ ?>