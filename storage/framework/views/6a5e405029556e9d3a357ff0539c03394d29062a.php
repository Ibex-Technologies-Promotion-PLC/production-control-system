<tr class="negative">
    <td class="center aligned collapsing">
        <span data-tooltip="<?php echo e(__('workorders.production_is_completed')); ?> - <?php echo e($workOrder->completedAt()); ?>" data-variation="mini" data-position="top left">
...
<?php $component = $__env->getContainer()->make(App\View\Components\MenuDropdown::class, ['main' => ''.e(__('common.confirm_or_deny')).'','action' => 'openApprovalModal('.e($workOrder->id).')','color' => 'red','icon' => 'tools icon']); ?>
...
</tr><?php /**PATH /var/www/html/resources/views/web/sections/workorders/daily/table-rows/wo-case-completed.blade.php ENDPATH**/ ?>