<!--[if BLOCK]><![endif]--><?php if($woLotPickerModal): ?>
    <div x-data="{woLotPickerModal: <?php if ((object) ('woLotPickerModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('woLotPickerModal'->value()); ?>')<?php echo e('woLotPickerModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('woLotPickerModal'); ?>')<?php endif; ?>}">
...
<?php $component = App\View\Components\CustomModal::resolve(['active' => 'woLotPickerModal'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
             ...
             <?php $__env->slot('header', null, []); ?> 
                <div>
                    <?php echo e($selectedIngredient->prd_code); ?>

                    <span class="text-sm">(<?php echo e($selectedIngredient->prd_name); ?>)</span>
                </div>
             <?php $__env->endSlot(); ?>

            <!--[if BLOCK]><![endif]--><?php if($selectedIngredient->isInStock): ?>
                <div class="bg-white" wire:key="do_<?php echo e($selectedIngredient); ?>">
                        ...
                        <div>
                            ...
                            <span class="text-green-600">
                                ...
                                <span class="text-ease">
                                    <?php echo e($this->getToBase()); ?>

                                    <?php echo e($selectedIngredient->baseUnit->name); ?>
                        ...
                        <div class="p-6 shadow-md flex flex-col gap-8 md:gap-4">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div wire:key="row_<?php echo e($key); ?>" class="flex flex-col md:flex-row gap-3 border border-dashed p-3 rounded-lg hover:border-orange-400 ease-in-out duration-200">
                                    ...
                                    <select class="form-select text-sm flex-1" wire:model.prevent="rows.<?php echo e($key); ?>.lot_number">
                                        <option value="" selected><?php echo e(__('dispatchorders.select_lot_number')); ?></option>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedIngredient->lots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = App\View\Components\Input::resolve(['type' => 'number','model' => 'rows.'.e($key).'.reserved_amount','placeholder' => ''.e(__('common.amount')).'','innerLabel' => ''.e($selectedIngredient->baseUnit->name).'','iClass' => 'disabled','noErrors' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                        <?php else: ?>
                                            <?php if (isset($component)) { $__componentOriginal786b6632e4e03cdf0a10e8880993f28a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal786b6632e4e03cdf0a10e8880993f28a = $attributes; } ?>
<?php $component = App\View\Components\Input::resolve(['type' => 'number','model' => 'rows.'.e($key).'.reserved_amount','placeholder' => ''.e(__('common.amount')).'','innerLabel' => ''.e($selectedIngredient->baseUnit->name).'','noErrors' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH /var/www/html/resources/views/web/sections/workorders/daily/prepare/work-order-lot-picker.blade.php ENDPATH**/ ?>