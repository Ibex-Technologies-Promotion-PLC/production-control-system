<tr class="font-semibold teal">
    <td class="center aligned collapsing">
        <span data-tooltip="<?php echo e(__('workorders.preparing')); ?>" data-variation="mini" data-position="top left">
...
<?php $component = $__env->getContainer()->make(App\View\Components\MenuDropdown::class, ['main' => ''.e(__('common.prepare')).'','action' => 'routePreparePage('.e($workOrder->id).')','color' => 'blue','icon' => 'open box icon']); ?>
...
<?php /**PATH /var/www/html/resources/views/web/sections/workorders/daily/table-rows/wo-case-preparing.blade.php ENDPATH**/ ?>