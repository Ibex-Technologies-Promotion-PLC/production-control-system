    ...
    $(document).ready(function() {
        ...
        function fetchValues() {
            ...
            <?php elseif($dataSource): ?>
                let data = window.livewire.find('<?php echo e($_instance->id); ?>').get('<?php echo e($dataSource); ?>');
                setValues(data);
            <?php else: ?> 
                window.livewire.find('<?php echo e($_instance->id); ?>').call('<?php echo e($dataSourceFunction); ?>').then(data => {
            ...
            if(data != null) {
                data.forEach(data => {
                    ...
                    values.push({
                        ...
                        selected: window.livewire.find('<?php echo e($_instance->id); ?>').get('<?php echo e($model); ?>') == data.<?php echo e($value); ?>,
                    });
                });
                populate(values);
            } else {
        ...
        function populate(values = null) {
            $(sId).dropdown({
                ...
                //     // window.livewire.find('<?php echo e($_instance->id); ?>').set('unit_id', value);
                // },
                message: {
...
</style><?php /**PATH D:\projects\hexlabs\production-control-system\resources\views/components/dropdown.blade.php ENDPATH**/ ?>