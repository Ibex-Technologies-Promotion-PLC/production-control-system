...
<?php endif; ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($this->producibles->count() <= 0): ?>
                    <div class="pt-2 font-semibold text-sm">!!! There are no products in the list, please <a
                        class="text-red-600" href="<?php echo e(route('products.create')); ?>">Start Here</a>...
        </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </form>
</div>
            ...
            <div wire:key="wire_card<?php echo e($key); ?>"
                ...
                <div
                    ...
                    <div class="flex gap-2 items-center">
                        <?php if (isset($component)) { $__componentOriginal4a0aa0dbff261054ba83150e9d676aae = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4a0aa0dbff261054ba83150e9d676aae = $attributes; } ?>
<?php $component = App\View\Components\Dropdown::resolve(['iModel' => 'cards.'.e($key).'.amount','iPlaceholder' => ''.e(__('validation.attributes.amount')).'','iType' => 'number','model' => 'cards.'.e($key).'.unit_id','dataType' => 'variable','dataSource' => 'cards.'.e($key).'.units','sId' => 'unit' . $key,'sClass' => 'basic','value' => 'id','text' => 'name','placeholder' => ''.e(__('units.unit')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
</div><?php /**PATH /var/www/html/resources/views/livewire/recipes/form.blade.php ENDPATH**/ ?>