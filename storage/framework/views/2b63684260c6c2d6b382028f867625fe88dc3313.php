<?php if($woLotPickerModal): ?>
    <div x-data="{woLotPickerModal: <?php if ((object) ('woLotPickerModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('woLotPickerModal'->value()); ?>')<?php echo e('woLotPickerModal'->hasModifier('defer') ? '.defer' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('woLotPickerModal'); ?>')<?php endif; ?>}">
        <?php if (isset($component)) { $__componentOriginal4a9d08a5bc2cd2a08efc7ebfee55e6d75aab1dd9 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\CustomModal::class, ['active' => 'woLotPickerModal']); ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <?php if($selectedIngredient->isInStock): ?>
                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div wire:key="row_<?php echo e($key); ?>" class="flex flex-col md:flex-row gap-3 border border-dashed p-3 rounded-lg hover:border-orange-400 ease-in-out duration-200">
                                    ...
                                    <select class="form-select text-sm flex-1" wire:model.prevent="rows.<?php echo e($key); ?>.lot_number">
                                        ...
                                        <?php $__currentLoopData = $selectedIngredient->lots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Input::class, ['type' => 'number','model' => 'rows.'.e($key).'.reserved_amount','placeholder' => ''.e(__('common.amount')).'','innerLabel' => ''.e($selectedIngredient->baseUnit->name).'','iClass' => 'disabled','noErrors' => true]); ?>
...
<?php endif; ?>
                                        <?php else: ?>
                                            <?php if (isset($component)) { $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Input::class, ['type' => 'number','model' => 'rows.'.e($key).'.reserved_amount','placeholder' => ''.e(__('common.amount')).'','innerLabel' => ''.e($selectedIngredient->baseUnit->name).'','noErrors' => true]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['wire:key' => 'reservedamountinput_'.e($key).'','class' => 'ui tiny input flex-1']); ?>
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/web/sections/workorders/daily/prepare/work-order-lot-picker.blade.php ENDPATH**/ ?>