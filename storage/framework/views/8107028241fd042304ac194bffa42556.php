<!--[if BLOCK]><![endif]--><?php if($wo_form_modal): ?>
    <div x-data="{wo_form_modal: <?php if ((object) ('wo_form_modal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('wo_form_modal'->value()); ?>')<?php echo e('wo_form_modal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('wo_form_modal'); ?>')<?php endif; ?>}">
...
<?php $component = App\View\Components\CustomModal::resolve(['active' => 'wo_form_modal','position' => 'center'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('work-orders.form', []);

$__html = app('livewire')->mount($__name, $__params, 'create-work-order-modal', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH /var/www/html/resources/views/web/sections/workorders/daily/form-modal.blade.php ENDPATH**/ ?>