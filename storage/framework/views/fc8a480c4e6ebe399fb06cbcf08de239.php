...
<?php endif; ?>
        ...
        <div class="h-20 p-3 px-5 flex justify-between items-center bg-gradient-to-b from-white to-gray-100">
            ...
            <a wire:navigate href="<?php echo e(route('work-orders.create')); ?>" data-tooltip="<?php echo e(__('workorders.create_work_order')); ?>"
                data-position="top left" data-variation="mini">
                <i class="large link project diagram icon"></i>
            </a>
            <a wire:navigate href="<?php echo e(route('stock-moves.create')); ?>" data-tooltip="<?php echo e(__('stockmoves.stock_moves_create')); ?>"
                data-position="top left" data-variation="mini">
                <i class="large link dolly flatbed icon"></i>
            </a>
            <a wire:navigate href="<?php echo e(route('inventory.index')); ?>">
                <i class="large link warehouse icon"></i>
            </a>
            <a wire:navigate href="<?php echo e(route('work-orders.daily')); ?>">
        ...
        <div class="flex flex-col ">
            ...
            <div x-data="{ submenu: false, submenuConfirm: false }" class="border-b border-dotted">
                ...
                <div
                    ...
                    <a wire:navigate href="<?php echo e(route($menu['name'])); ?>"
                    ...
                    <div class="flex-1">
                        ...
                        <div
                            ...
                            <div class="flex-1 px-4 font-bold cursor-pointer">
                                <a wire:navigate href="<?php echo e(route($submenu['name'])); ?>">
                                    <div
