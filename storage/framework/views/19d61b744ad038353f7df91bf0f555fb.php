...
<?php $component = App\View\Components\PageHeader::resolve(['icon' => 'brown box','header' => 'products.edit_product'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('products.form', ['product' => $product]);

$__html = app('livewire')->mount($__name, $__params, 'lw-752615086-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/web/sections/products/edit.blade.php ENDPATH**/ ?>