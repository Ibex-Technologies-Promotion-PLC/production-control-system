...
<script>
    $('#<?php echo e($dId); ?>')
        .calendar({
            ...
            today: true,
            touchReadonly: false,
            <!--[if BLOCK]><![endif]--><?php if($initialDate): ?>
                initialDate: new Date('<?php echo e($initialDate); ?>'),
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <!--[if BLOCK]><![endif]--><?php if($disabledDays): ?>
            ...
            onSelect: function(date, mode) {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('<?php echo e($model); ?>', new Date(date + 'z')); // 'z' timezone olayları ile ilgili
...
</script><?php /**PATH C:\Users\Muluye\Documents\production-control-system\resources\views/components/datepicker.blade.php ENDPATH**/ ?>