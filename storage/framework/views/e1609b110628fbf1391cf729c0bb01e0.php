<!--[if BLOCK]><![endif]--><?php if($paginator->hasPages()): ?>
    <div class="px-3 py-4 bg-teal-100 md:border border-b md:border-t-0 md:rounded-b">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-gray-700 leading-5">
                        ...
                        <span><?php echo e(__('datatable.showing_firstItem_to_lastItem_of_total_results', 
                            [
                                    ...
                                    <span wire:key="paginator-page<?php echo e($page); ?>">
                                        <!--[if BLOCK]><![endif]--><?php if($page == $paginator->currentPage()): ?>
                                            <span aria-current="page">
                                                <span class="bg-gray-800 relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white border border-gray-300 cursor-default leading-5"><?php echo e($page); ?></span>
                                            </span>
                                        <?php else: ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<?php /**PATH C:\Users\Muluye\Documents\production-control-system\resources\views/components/tailwind-pagination.blade.php ENDPATH**/ ?>