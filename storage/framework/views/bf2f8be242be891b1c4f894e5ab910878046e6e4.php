...
} elseif ($_instance->childHasBeenRendered('xPoHbPK')) {
    $componentId = $_instance->getRenderedChildComponentId('xPoHbPK');
    $componentTag = $_instance->getRenderedChildComponentTagName('xPoHbPK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xPoHbPK');
} else {
    $response = \Livewire\Livewire::mount('tools.toaster', []);
    $html = $response->html();
    $_instance->logRenderedChild('xPoHbPK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\projects\hexlabs\production-control-system\resources\views/web/layouts/app.blade.php ENDPATH**/ ?>