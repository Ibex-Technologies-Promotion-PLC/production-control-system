...
<?php $component = App\View\Components\Input::resolve(['model' => 'ctg_name','label' => ''.e(__('validation.attributes.ctg_name')).'','noErrors' => true,'placeholder' => ''.e(__('validation.attributes.ctg_name')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
</div><?php /**PATH C:\Users\Muluye\Documents\production-control-system\resources\views/web/sections/categories/ctg-baseform.blade.php ENDPATH**/ ?>