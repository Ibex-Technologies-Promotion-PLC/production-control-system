<div>
    <div class="text-green-500 cursor-default">
        ...
        <span class="font-bold text-sm">
            <?php echo e(__('dispatchorders.dispatch_process_finalized')); ?>
     ...
     <?php $__env->slot('bottom', null, []); ?> 
        <div class="shadow rounded p-2 bg-white text-xs">
            ...
            <span class="text-ease">
                - <?php echo e($dispatchOrder->do_actual_datetime); ?>

            </span>

        </div>
     <?php $__env->endSlot(); ?>
</div><?php /**PATH D:\projects\hexlabs\production-control-system\resources\views/web/sections/dispatchorders/daily/prepare/table-by-states/prepare-approved.blade.php ENDPATH**/ ?>