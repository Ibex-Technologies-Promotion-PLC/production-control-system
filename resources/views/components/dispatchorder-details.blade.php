        ...
        <div class="p-4 shadow-lg border rounded {{ $tableClass['borderColor'] }}">
            ...
            @if ($dispatchOrder->dispatchExtra)
                ...
                <x-list-item>
                    ...
                    <span>{{ $dispatchOrder->dispatchExtra->de_dispatch_expense ?? __('common.not_defined') }} Br</span>
                </x-list-item>
                <x-list-item>
                    <span>{{ __('validation.attributes.de_handling_expense') }}</span>
                    <span>{{ $dispatchOrder->dispatchExtra->de_handling_expense ?? __('common.not_defined') }} Br</span>
                </x-list-item>
            @endif
